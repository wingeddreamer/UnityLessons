...
public class GameGUI : MonoBehaviour {
    ...
    void OnGUI()
    {
        ...
        GUI.DrawTexture(new Rect(Input.mousePosition.x-drawCursorSize/2,Screen.height-Input.mousePosition.y- drawCursorSize / 2, drawCursorSize, drawCursorSize), cursorTextureBig);
    }
